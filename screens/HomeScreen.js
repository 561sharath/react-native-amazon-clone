    ...
    return (
      <>
        <SafeAreaView style={{
            ...
            <ScrollView>
                ...
                style={{
                    ...
                    <Pressable>
                        ...
                        >Deliver To Sharath-Hindupur,515201</Text>
                    </Pressable>
          ...
          images={images} autoplay circleLoop dotColor={"#13274F"}
          inactiveDotColor="#90A4AE" ImageComponentStyle={{width:"100%"}}
          ...
          <ModalContent style={{
            ...
            <ScrollView>
              ...
              style={{
                ...
                >Add a Address or pick-up point</Text>
              </Pressable>
            </ScrollView>
            <View style={{
              ...
              <Text>
              <MaterialIcons name="location-pin" size={20} color="#0066b2" />
              <Text style={{
                color:'#0066b2',
                fontWeight:'400'
              ...
              <Text>
              <MaterialIcons name="location-searching" size={20} color="#0066b2" />
              <Text style={{
                color:'#0066b2',
                fontWeight:'400'
