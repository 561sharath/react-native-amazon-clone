...
const CartScreen=()=>{
    ...
    const increasequantity=(item)=>(
        dispacth(incrementQuantity(item))

    )

    const decreaseQuantity=(item)=>(
        dispacth(decrementQuantity(item))
    )
    ...
    return(
        <ScrollView style={{
            ...
            <View style={{
                ...
                <Text style={{
                    marginHorizontal:10
                }}>EMI details Available</Text>

                <Pressable onPress={()=>navigation.navigate("Confirm")}
                style={{
                    backgroundColor:'#FFC72C',padding:10,
                    borderRadius:5,
                ...
                />
                <Text style={{ color: "green",marginLeft:20 }}>In Stock</Text>
                                </View>
                            </Pressable>
